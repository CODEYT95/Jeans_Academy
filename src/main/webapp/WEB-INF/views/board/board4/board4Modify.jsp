    ...
    <div class="main--content">
        <form action="/board4/modify" method="post">
            ...
            <div class="head-container">
                ...
                <button type="button" class="main-ori-button" onclick="location.href='/board4/detail/${board4DTO.board4_no}'">목록</button>
            ...
            <div class="content-container">
                <div class="write-content">
                    ...
                    <textarea class="content-textarea" contenteditable="true" name="board4_content" placeholder="내용을 입력하세요" required>${board4DTO.board4_content}</textarea>
