...
<html xmlns:c="http://java.sun.com/JSP/Page" xmlns:fmt="http://java.sun.com/JSP/Page">
<head>
                    ...
                    <c:forEach items="${comment3DTO}" var="comment3DTO" varStatus="loop" begin="0">
                        <li>
                            <table>
                                ...
                                <td class="col-2"><c:out value="${comment3DTO.member_id}"/></td>
                                            ...
                                            <div class="modal-body">
                                                <form action="/comment3/update" method="post">
                                                    ...
                                                    <div id="comment_content" class="form-group">
                                                        <h3>댓글 내용</h3>
                                                        <input type="text" name="comment3_content" required/>
                                                    </div>
                                                    <br/>
