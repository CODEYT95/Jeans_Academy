...
<div class="main--content">
    <form action="/board3/modify" method="post">
        ...
        <div class="head-container">
            ...
            <button type="button" class="main-ori-button3" onclick="location.href='/board3/detail/${board3DTO.board3_no}'">취소</button>
            <div class="title-container">
                <div class="write-title">
                    <div class="text">글 수정</div>
                    <label>
                        <div><span>제목</span></div>
                        <textarea id="board3_title" name="board3_title" placeholder="제목을 입력하세요" maxlength="20" required>${board3DTO.board3_title}</textarea>
                    </label>
                </div>
            </div>
        </div>
