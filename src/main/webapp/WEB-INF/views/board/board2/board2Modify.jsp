    ...
    <div class="main--content">
        <form action="/board2/modify" method="post">
            ...
            <div class="head-container">
                ...
                <button type="button" class="main-ori-button" onclick="location.href='/board2/detail/${board2DTO.board2_no}'">목록</button>
            ...
            <div class="content-container">
                <div class="write-content">
                    ...
                    <textarea class="content-textarea" contenteditable="true" name="board2_content" placeholder="내용을 입력하세요" required>${board2DTO.board2_content}</textarea>
