...
<div class="main--content">
    <form action="/board2/write" method="post" enctype="multipart/form-data">
        ...
        <div class="head-container">
            <button id="save" class="main-ori-button2">저장</button>
            <button type="button" class="main-ori-button2" onclick="location.href='/board2/list'">취소/목록</button>
            <div class="title-container">
                <div class="write-title">
                    <div class="text">글 작성</div>
                    <label>
                        <div><span>제목</span></div>
                        <textarea id="board2_title" name="board2_title" placeholder="제목을 입력해주세요" maxlength="20" required></textarea>
                    </label>
                </div>
            </div>
        </div>
